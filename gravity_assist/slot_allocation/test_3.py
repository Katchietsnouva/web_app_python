...
# Convert parking slot assignments to JSON format
json_assignments = parking_assignments_to_json(parking_assignments)
print(json.dumps(json_assignments, indent=4))
